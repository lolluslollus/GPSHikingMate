...
// LOLLO download SQLite for Windows Phone 8.1, install it, restart visual studio. no nuget or github required.
...
namespace LolloGPS.Data
{
	internal static class DBManager
	{
		...
		internal static Semaphore _HistorySemaphore = new Semaphore(1, 1, "GPSHikingMate_HistorySemaphore");
		internal static Semaphore _Route0Semaphore = new Semaphore(1, 1, "GPSHikingMate_Route0Semaphore");
		internal static Semaphore _LandmarksSemaphore = new Semaphore(1, 1, "GPSHikingMate_LandmarksSemaphore");
	...
	internal static class LolloSQLiteConnectionPoolMT
	{
		...
		private static Semaphore _entriesSemaphore = new Semaphore(1, 1, "GPSHikingMate_SQLiteEntriesSemaphore");
		private static volatile bool _isClosed = true;
		private static Semaphore _isClosedSemaphore = new Semaphore(1, 1, "GPSHikingMate_SQLiteIsClosedSemaphore");
		...
		private static Semaphore _dbActionInOtherTaskSemaphore = new Semaphore(1, 1, "GPSHikingMate_SQLiteDbActionInOtherTaskSemaphore");
		/// <summary>
